                ...
                <ul className="list-disc pl-[35px] space-y-2 lg:text-lg">
                  <li>
                    <p>
                      ...
                      la escalabilidad, rendimiento y mantenibilidad del
                      proyecto.
                    </p>
                  </li>
                  <li>
                    <p>
                      ...
                      <strong>Adapter</strong> para estandarizar el consumo de
                      datos del backend.
                    </p>
                  </li>
                  <li>
                    <p>
                      Desarrollé, mejoré módulos del ERP interno, optimizando la
                  ...
                  <li>
                    <p>
                      ...
                      reduciendo el acoplamiento y facilitando la colaboración
                      entre equipos.
                    </p>
                  </li>
                </ul>
            ...
            <div className="space-y-4 grid grid-cols-1 w-full lg:grid-cols-3 lg:space-y-0">
              <div className="lg:col-span-2 w-full">
                ...
                <ul className="list-disc pl-[35px] space-y-2 lg:text-lg">
                  ...
                  <li>
                    <p>
                      Implementación de página principal y página adicional.
                    </p>
                  </li>
                  <li>
                    <p>
